//'use strict';
//
//function PayDataEntryPayGroupDetailsService($resource,$rootScope){
...
//}
//
//angular.module('payDataEntryApp').service('PayDataEntryPayGroupDetailsService', ['$resource','$rootScope',PayDataEntryPayGroupDetailsService]);
